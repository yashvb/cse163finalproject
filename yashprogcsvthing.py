...
for i in range(len(thing)):
    ...
    if type(thing[i]["FIELD2"]) == str:
      if thing[i]["FIELD2"] == "N/A":
        ...
        thing[i]["FIELD2"] = float(re.split(r'[\"]?([0-9\.]*)[\"]?',thing[i]["FIELD2"])[1])
    if type(thing[i]["FIELD3"]) == str:
      if thing[i]["FIELD3"] == "N/A":
        thing[i]["FIELD3"] = 0.0
      else:
        thing[i]["FIELD3"] = float(re.split(r'[\"]?([0-9\.]*)[\"]?',thing[i]["FIELD3"])[1])
    if type(thing[i]["FIELD4"]) == str:
      if thing[i]["FIELD4"] == "N/A":
        thing[i]["FIELD4"] = 0.0
      else:
        thing[i]["FIELD4"] = float(re.split(r'[\"]?([0-9\.]*)[\"]?',thing[i]["FIELD4"])[1])
    if type(thing[i]["FIELD5"]) == str:
      if thing[i]["FIELD5"] == "N/A":
        thing[i]["FIELD5"] = 0.0
      else:
        thing[i]["FIELD5"] = float(re.split(r'[\"]?([0-9\.]*)[\"]?',thing[i]["FIELD5"])[1])
    if type(thing[i]["FIELD6"]) == str:
      if thing[i]["FIELD6"] == "N/A":
        thing[i]["FIELD6"] = 0.0
      else:
        thing[i]["FIELD6"] = float(re.split(r'[\"]?([0-9\.]*)[\"]?',thing[i]["FIELD6"])[1])
    if type(thing[i]["FIELD7"]) == str:
      if thing[i]["FIELD7"] == "N/A":
        thing[i]["FIELD7"] = 0.0
      else:
        thing[i]["FIELD7"] = float(re.split(r'[\"]?([0-9\.]*)[\"]?',thing[i]["FIELD7"])[1])
    if type(thing[i]["FIELD8"]) == str:
      if thing[i]["FIELD8"] == "N/A":
        thing[i]["FIELD8"] = 0.0
      else:
        thing[i]["FIELD8"] = float(re.split(r'[\"]?([0-9\.]*)[\"]?',thing[i]["FIELD8"])[1])
    if type(thing[i]["FIELD9"]) == str:
      if thing[i]["FIELD9"] == "N/A":
        thing[i]["FIELD9"] = 0.0
      else:
        thing[i]["FIELD9"] = float(re.split(r'[\"]?([0-9\.]*)[\"]?',thing[i]["FIELD9"])[1])
    if type(thing[i]["FIELD10"]) == str:
      if thing[i]["FIELD10"] == "N/A":
        thing[i]["FIELD10"] = 0.0
      else:
        thing[i]["FIELD10"] = float(re.split(r'[\"]?([0-9\.]*)[\"]?',thing[i]["FIELD10"])[1])
